...
public class Araba {
    /*
     Javada her class olusturdugumuzda java o class'dan ileride objeler den
     üretmek gerekeceğini bilir ve bir özellğini belirtmesek de Java her olusturgugu
...
// kod blogunun method veya constructor olamsından emin olmak istiyorsaniz
    ...
    public Araba(int yil, String renk, String vites) {
        System.out.println(yil + " model " + renk + " ve " + vites + " vites bir araba uretildi");
    }
